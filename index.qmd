...
<hr>
:::{.tech-fact-bar}
<div id="tech-fact">💡 Loading fact...</div>
:::
...
// Rotate tech facts every 30 seconds
let factIndex = 0;
...
rotateTechFact();
function startRandomFactRotation() {
  rotateTechFact(); // show first fact
  setTimeout(function loop() {
    rotateTechFact();
    const nextInterval = Math.floor(Math.random() * (14000 - 10000 + 1)) + 10000;
    setTimeout(loop, nextInterval);
  }, Math.floor(Math.random() * (14000 - 10000 + 1)) + 10000);
}

startRandomFactRotation();
</script>
